...
SELECT 
    ...
    NULL as team,
    NULL as country,
    "{{ var("table_prefix") }}_users".dtcontractstart::string as contract_start_date,
    "{{ var("table_prefix") }}_users".dtcontractend::string as contract_end_date,
    "{{ var("table_prefix") }}_users".gender as gender,
    "{{ var("table_prefix") }}_users_department".name as business_unit,
    "{{ var("table_prefix") }}_users".employeenumber as employee_number,
